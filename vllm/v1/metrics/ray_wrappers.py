...
class RayPrometheusMetric:
    ...
    def _get_sanitized_opentelemetry_name(name: str) -> str:
        ...
        # ruff: noqa: E501
        Ref: https://github.hyhy.fun/open-telemetry/opentelemetry-cpp/blob/main/sdk/src/metrics/instrument_metadata_validator.cc#L22-L23
        Ref: https://github.hyhy.fun/ray-project/ray/blob/master/src/ray/stats/metric.cc#L107
        """
