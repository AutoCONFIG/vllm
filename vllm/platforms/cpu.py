...
class CpuPlatform(Platform):
    ...
    def check_and_update_config(cls, vllm_config: VllmConfig) -> None:
        ...
        if (
            ...
            # See: https://github.hyhy.fun/vllm-project/vllm/issues/27369
            # TODO: Remove once:
            # https://github.hyhy.fun/pytorch/pytorch/issues/166087 is fixed

            # We need to find the location of PyTorch's libgomp
            torch_pkg = os.path.dirname(torch.__file__)
            site_root = os.path.dirname(torch_pkg)
            # Search both torch.libs and torch/lib - See: https://github.hyhy.fun/vllm-project/vllm/issues/30470
            torch_libs_paths = [
